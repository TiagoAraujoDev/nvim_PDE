local M = {
  ...
  commit = "96e3978c3fdae3950f6ccda548775e8b8952f74a",
  ft = { "java" },
}
...
M.opts = function()
  ...
  local on_attach = function(client, bufnr)
    ...
    keymap(bufnr, "n", "<leader>lo", "<Cmd>lua require('jdtls').organize_imports()<CR>", { noremap = true, silent = true, desc = "Organize imports" })
    keymap(bufnr, "n", "<leader>le", "<Cmd>lua require('jdtls').extract_variable()<CR>", { noremap = true, silent = true, desc = "Extract variable" })
    keymap(bufnr, "n", "<leader>lc", "<Cmd>lua require('jdtls').extract_constant()<CR>", { noremap = true, silent = true, desc = "Extract constant" })

    -- compile (javac)
    keymap(bufnr, "n", "<leader>lc", "<Cmd>!javac -d bin src/**/*.java<CR>", { noremap = true, silent = true, desc = "Compile java code" })
  ...
  local defaults = {
    cmd = {
      ...
      "/home/tma/.local/share/nvim/mason/packages/jdtls/plugins/org.eclipse.equinox.launcher_1.6.500.v20230717-2134.jar",
